//changes to the DOM via jquery (ie appending a new html element will occur instantly on the page)
...
//maybe just load from database on refresh/revise to page
//for all else, just add directly to the html
//for delete just delete straight from the html
//but still edit the database
function loadPage() {
